import { BlockImage, Note, RegoRecipeCodeBlock } from '@/components';

import { getExampleById } from 'epm-policy-examples';

export const simpleTagTemplate = getExampleById('simple-tag-check');
export const timeCvssTemplate = getExampleById('time-based-cvss-policy');
export const recipe3Template = getExampleById('recipe-3');
...
<RegoRecipeCodeBlock rego={simpleTagTemplate?.rego} />
...
<RegoRecipeCodeBlock rego={timeCvssTemplate?.rego} />
...
<RegoRecipeCodeBlock rego={recipe3Template?.rego} />
