...
import hiddenPackageToast from 'src/content/supply-chain-security/images/hidden-pkg-explainer.png'
import hiddenPackageSearch from 'src/content/supply-chain-security/images/view-hidden-packages.png'
import cooldownPolicyView from 'src/content/supply-chain-security/images/cooldown-policy-view.png'
...
<Note variant="note"> A cooldown policy is always set to **Terminal**, which prevents the evaluation of any further policies if this policy matches. This setting cannot be edited. </Note>


<Note> Precedence for a cooldown policy is always set to `0`. 
...
<BlockImage src={cooldownPolicyView} alt="Cooldown policy view"></BlockImage>
...
<BlockImage src={hiddenPackageSearch} alt="Hidden package search results"></BlockImage>

Hovering over the **HIDDEN** status in the web app will display why the package is hidden:

<BlockImage src={hiddenPackageToast} alt="Hidden status"></BlockImage>
