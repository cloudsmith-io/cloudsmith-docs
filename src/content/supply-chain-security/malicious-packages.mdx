...
Malicious packages information is available via [Enterprise Policy Management](/supply-chain-security/continuous-security) and [Continuous Security](/supply-chain-security/epm/) features (both in Early Access). This means, you can create your own policies to take action when a malicious package is detected.
