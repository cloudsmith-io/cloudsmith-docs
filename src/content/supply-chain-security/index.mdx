...
- Reduce risk associated with **Software Vulnerabilities**, **Malware**, and **Malicious Packages**, by proactively quarantining packages and preventing them from entering your software supply chain.
