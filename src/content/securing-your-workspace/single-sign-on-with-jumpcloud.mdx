...
Take this file and add the XML contents to your [SAML settings](/securing-your-workspace/single-sign-on#enable-saml) in your Cloudsmith organization.
...
You can then enable SAML in your Cloudsmith [SAML settings](/securing-your-workspace/single-sign-on#enable-saml). 

You'll be able to access the landing page of your organization at the following URL:  https://cloudsmith.io/orgs/ORG/saml/login/
