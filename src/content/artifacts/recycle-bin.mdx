...
You can also restore artifacts to the repository from the Recycle Bin. This can be useful in cases of accidental artifact deletion or when evaluating/configuring [Artifact Lifecycle](/artifacts/retention-lifecycle) rules.    
