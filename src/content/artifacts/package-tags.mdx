...
To add or modify tags using the Cloudsmith CLI, you first need to identify the package you wish to tag or modify.  See [Package Identification](doc:identifying-a-package) for instructions to do this. 
