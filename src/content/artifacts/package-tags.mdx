...
Package tags allow you to add your own custom tags to your packages. You can then use tags to group and sort your packages via search queries (see <a href="https://help.cloudsmith.io/docs/search-packages">Searching/Filtering</a> for details), or to help you organize your packages in a way that suits you.
