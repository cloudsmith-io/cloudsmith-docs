...
To resync a package using the Cloudsmith CLI, you first need to identify the package. See [Package Identification](/artifacts/identifying-a-package) for instructions to do this. 
