...
To move a package using the Cloudsmith CLI, you first need to identify the package you wish to move.  See [Package Identification](/artifacts/identifying-a-package) for full instructions on identifying packages. 
