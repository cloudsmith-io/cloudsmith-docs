...
- **Repository package list and search results**: In the Cloudsmith UI, packages from configured connected repositories do not appear in the package list or web search results for the primary repository, even though they are still resolvable through the primary repository using native package management tools.
