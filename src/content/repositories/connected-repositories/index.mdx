...
import connectedRepoExample from './images/connected-repository-example.png'

# Connected Repositories

<Note variant="important" headline="Early Access">
Connected Repositories are in Early Access (EA) and are currently supported for Maven, Docker, Python, NPM, Go, Cargo (Rust), NuGet and Helm. Please contact us if you are interested in trying them.
</Note>
...
<BlockImage src={connectedRepoExample} alt="Example Connected Repository Configuration"></BlockImage>
