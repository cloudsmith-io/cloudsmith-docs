...
- **Repository package list and search results**: Packages from configured connected repositories do not appear in the package list or search results for the primary repository.
