...
- [Via the Cloudsmith CLI](#via-the-cloudsmith-cli)
- [Via the Cloudsmith web app](#via-the-cloudsmith-web-app)
- [Via the Cloudsmith API](#via-the-cloudsmith-api)
...
|:---|:---|
|WORKSPACE|A Cloudsmith workspace name|
