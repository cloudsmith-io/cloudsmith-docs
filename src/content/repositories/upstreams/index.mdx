...
|:---|:---|:---|:---|:---|:---|
|[Alpine / Wolfi](/formats/alpine-repository) | ✅ | ✅ | ✅ |<div class="cs-center">Ahead-of-Time</div>|  [API](/api/repos/upstream/apk/create) |
...
|[Generic](/formats/generic-repository) | ✅ | ✅ | ✅ |<div class="cs-center">Just-in-Time</div>|  [API](/api/repos/upstream/generic/create) |
...
#### Create an Alpine / Wolfi Upstream
...
Cloudsmith automatically detects whether an upstream is Alpine Linux or Wolfi based on the URL domain. URLs containing `alpinelinux.org` are treated as Alpine Linux; URLs containing `wolfi.dev` or `cgr.dev` are treated as Wolfi. For unrecognized domains, Alpine Linux is assumed by default.
</Note>
