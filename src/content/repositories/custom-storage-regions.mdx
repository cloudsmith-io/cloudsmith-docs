...
import imgd0954bd_storage_region from './images/custom-storage-regions/d0954bd-storage_region.png'
import img4583ac7_Transfer_Repo_Button from './images/custom-storage-regions/4583ac7-Transfer_Repo_Button.png'
import imgabd679b_transfer_repo_form from './images/custom-storage-regions/abd679b-transfer-repo-form.png'
...
<BlockImage src={imgd0954bd_storage_region} alt="Create Package Repository Form"></BlockImage>
...
<BlockImage src={img4583ac7_Transfer_Repo_Button} alt="Transfer Repository Button"></BlockImage>

You will then be presented with the Transfer Repository Form: 

<BlockImage src={imgabd679b_transfer_repo_form} alt="Transfer Repository Form"></BlockImage>
