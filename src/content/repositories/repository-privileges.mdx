...
<Note variant="note" headline="Fine-tuning Privileges">
Note that this privileges can be fine tuned per action (see [Repository privileges](#repository-privileges)).
</Note>

<Note variant="note" headline="Public repositories">
