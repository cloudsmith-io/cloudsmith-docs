...
To install Wolfi packages from a public Cloudsmith repository, set up the repository using the following:
...
To install Wolfi packages from a private Cloudsmith repository, set up the repository using the following:
