...
publishing {
  repositories {
    maven {
      name = "cloudsmith"
      url = "https://maven.cloudsmith.io/WORKSPACE/REPOSITORY/"
      def releasesRepoUrl = "https://maven.cloudsmith.io/WORKSPACE/REPOSITORY/"
      def snapshotsRepoUrl = "https://maven.cloudsmith.io/WORKSPACE/REPOSITORY/"
...
repositories {
  maven {
    url "https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/maven/"
  }
}
```
...
repositories {
  maven {
    url "https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/maven/"
  }
}
```
...
repositories {
  maven {
    url "https://dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/maven/"
