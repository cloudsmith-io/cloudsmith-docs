...
Then, [get your API_TOKEN](/accounts-and-teams/api-key#getting-your-api-key) and login to your private Cloudsmith Swift registry with:
...
let package = Package(
    name: "MySwiftApp",
    dependencies: [
        .package(id: "alamofire.alamofire", from: "5.9.1")
    ],
    targets: [
        .executableTarget(
            name: "MySwiftApp",
...
You will see output indicating that Swift is downloading `alamofire.alamofire` directly from your Cloudsmith registry. You should see the following printed out when resolving dependencies:
...
<Note variant="note" headline="Public upstreams">
