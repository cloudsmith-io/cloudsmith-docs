...
```shell
cloudsmith push composer WORKSPACE/REPOSITORY PACKAGE_NAME.phar
```
...
"repositories": [
  {
    "type": "composer",
    "url": "https://composer.cloudsmith.io/WORKSPACE/REPOSITORY/",
    "options": {
    }
  }
]
...
"repositories": [
  {
    "type": "composer",
    "url": "https://composer.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/",
    "options": {
    }
  }
]
...
"repositories": [
  {
    "type": "composer",
    "url": "https://composer.cloudsmith.io/basic/WORKSPACE/REPOSITORY/",
    "options": {
    }
  }
]
