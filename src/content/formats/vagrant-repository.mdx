...
```shell
cloudsmith push vagrant WORKSPACE/REPOSITORY BOX_NAME.box --provider PROVIDER_NAME --name BOX_NAME --version BOX_VERSION
```
...
```shell
vagrant box add 'https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json' \
  --name 'BOX_NAME' \
...
vagrant box add 'https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json' \
  --name 'BOX_NAME' \
  --box-version 'BOX_VERSION' \
  --provider 'PROVIDER_NAME'
```
```shell HTTP Basic Auth (User & Pass)
vagrant box add 'https://USERNAME:PASSWORD@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json' \
  --name 'BOX_NAME' \
  --box-version 'BOX_VERSION' \
  --provider 'PROVIDER_NAME'
```
```shell HTTP Basic Auth (API Key)
vagrant box add 'https://USERNAME:API-KEY@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json' \
  --name 'BOX_NAME' \
  --box-version 'BOX_VERSION' \
  --provider 'PROVIDER_NAME'
```
```shell HTTP Basic Auth (Token)
vagrant box add 'https://token:TOKEN@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json' \
  --name 'BOX_NAME' \
  --box-version 'BOX_VERSION' \
  --provider 'PROVIDER_NAME'
```
...
config.vm.box_url = "https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json"
```
...
```shell Entitlement Token Auth
config.vm.box = "BOX_NAME"
config.vm.box_url = "https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json"
```
```shell HTTP Basic Auth (User & Pass)
config.vm.box = "BOX_NAME"
config.vm.box_url = "https://USERNAME:PASSWORD@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json"
```
```shell HTTP Basic Auth (API Key)
config.vm.box = "BOX_NAME"
config.vm.box_url = "https://USERNAME:API-KEY@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json"
```
```shell HTTP Basic Auth (Token)
config.vm.box = "BOX_NAME"
config.vm.box_url = "https://token:TOKEN@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/vagrant/BOX_NAME/metadata.json"
```
