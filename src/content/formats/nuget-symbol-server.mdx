...
import nuget_pdb_file from './images/nuget-symbol-server/nuget_pdb_file.png';
...
https://nuget.cloudsmith.io/WORKSPACE/REPOSITORY/download/symbols
```
...
<BlockImage src={nuget_pdb_file} alt=""></BlockImage>
