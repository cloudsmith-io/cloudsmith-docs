...
```
https://ruby.cloudsmith.io/WORKSPACE/REPOSITORY/
```
...
gem push PACKAGE_NAME-VERSION.gem \
  --host 'https://ruby.cloudsmith.io/WORKSPACE/REPOSITORY'
```
...
```shell
cloudsmith push ruby WORKSPACE/REPOSITORY PACKAGE_NAME-PACKAGE_VERSION.gem
```
...
```shell
source 'https://dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/ruby/' do
...
source 'https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/ruby/' do
  gem 'PACKAGE-NAME', '~> PACKAGE_VERSION'
end
```
```shell HTTP Basic Auth (User & Pass)
source 'https://USERNAME:PASSWORD@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/ruby/' do
  gem 'PACKAGE-NAME', '~> PACKAGE_VERSION'
end
```
```shell HTTP Basic Auth (API-Key)
source 'https://USERNAME:API-KEY@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/ruby/' do
  gem 'PACKAGE-NAME', '~> PACKAGE_VERSION'
end
```
```shell HTTP Basic Auth (Token)
source 'https://token:TOKEN@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/ruby/' do
  gem 'PACKAGE-NAME', '~> PACKAGE_VERSION'
end
```
...
```shell
gem sources --add 'https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/ruby/'
```
...
```shell Entitlement Token Auth
gem sources --add 'https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/ruby/'
```
```shell HTTP Basic Auth (User & Pass)
gem sources --add 'https://USERNAME:PASSWORD@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/ruby/'
```
```shell HTTP Basic Auth (API-Key)
gem sources --add 'https://USERNAME:API-KEY@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/ruby/'
```
```shell HTTP Basic Auth (Token)
gem sources --add 'https://token:TOKEN@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/ruby/'
```
...
```shell
source 'https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/ruby/' do
