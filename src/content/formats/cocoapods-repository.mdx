...
```shell
cloudsmith push cocoapods WORKSPACE/REPOSITORY PACKAGE_NAME.tar.gz
```
...
```shell
source 'https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/cocoapods/index.git'
```
...
source 'https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/cocoapods/index.git'
```
```shell HTTP Basic Auth (User & Pass)
source 'https://USERNAME:PASSWORD@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/cocoapods/index.git'
```
```shell HTTP Basic Auth (API Key)
source 'https://USERNAME:API-KEY@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/cocoapods/index.git'
```
```shell HTTP Basic Auth (Token)
source 'https://token:TOKEN@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/cocoapods/index.git'
```
...
source 'https://dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/cocoapods/index.git'
target 'MyApp' do
  pod 'PACKAGE_NAME', '~> PACKAGE_VERSION'
end
```
