...
Cloudsmith provides support for Docker's Hardened Image registry via upstreams. To learn how to configure an upstream for it visit our [Docker Hardened Images](/integrations/integrating-with-docker-hardened-images) documentation.
</Note>
