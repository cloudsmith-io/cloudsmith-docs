...
<Note>📘 **OCI SUpport**
Cloudsmith provides public & private registries for OCI artifacts, to learn more about it visit our [OCI Repository ](https://help.cloudsmith.io/docs/oci-repository) documentation.</Note>
