...
```shell
docker tag IMAGE_NAME:TAG docker.cloudsmith.io/WORKSPACE/REGISTRY/IMAGE_NAME:TAG
```
...
```shell
docker push docker.cloudsmith.io/WORKSPACE/REGISTRY/IMAGE_NAME:TAG
```
...
```shell
cloudsmith push docker WORKSPACE/REGISTRY IMAGE_NAME.docker
```

Example: 

```shell
cloudsmith push docker my-workspace/my-repo your-image.docker
```
...
```shell
docker pull docker.cloudsmith.io/WORKSPACE/REGISTRY/IMAGE_NAME:TAG
```

To refer to this image after pulling in a Dockerfile, specify the following:

```
FROM docker.cloudsmith.io/WORKSPACE/REGISTRY/IMAGE_NAME:TAG
```
