...
Cloudsmith provides support for Docker Hardened Images via upstreams. To learn how to configure an upstream for this registry, visit our [Docker Hardened Images](/integrations/integrating-with-docker-hardened-images) documentation.
</Note>
