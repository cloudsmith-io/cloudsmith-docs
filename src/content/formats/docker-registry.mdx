...
<Note variant="note" headline="OCI Support">
Cloudsmith provides public & private registries for OCI artifacts, to learn more about it visit our [OCI Repository ](/formats/oci-repository) documentation.
</Note>

<Note variant="note" headline="Docker DHI Support">
Cloudsmith provides support for Docker Hardened Image registry via upstreams. To learn how to configure an upstream for this registry, vist our [Docker Hardened Images](/integrations/integrating-with-docker-hardened-images) documentation.
</Note>
...
<Note variant="note" headline="Custom Domains">
...
<Note variant="note" headline="About 'latest' tags">
