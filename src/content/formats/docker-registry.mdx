...
Cloudsmith's Docker repositories benefit from native Docker [image layer storage deduplication](https://docs.docker.com/get-started/docker-concepts/building-images/understanding-image-layers/) technology. This means that if you upload several images sharing some of their composing layers, those layers will be reused. This reduce the amount of artifact data and package delivery required to distribute the images.
</Note>
