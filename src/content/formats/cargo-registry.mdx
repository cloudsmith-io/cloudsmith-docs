...
Cloudsmith supports [https://crates.io/](https://crates.io/) as an upstream. This allows you to proxy and cache Rust crates not yet in your repository through Cloudsmith for your Rust projects.

To enable it for your repository, browse to your repository overview page and click in the Upstreams tab. Then, click on **+ Add Upstream Proxy** and then choose the **Rust** format Upstream.

In the Upstream creation menu, define a name your Upstream and in the **Proxy URL** field insert `https://crates.io/`. Click on **+ Create Upstream Proxy** and the upstream shoud become immediately available.

{/* <BlockImage src={rust_upstream} alt=""></BlockImage> */}
