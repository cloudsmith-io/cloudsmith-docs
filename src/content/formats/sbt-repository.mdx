...
```scala
publishTo := { Some("Cloudsmith API" at "https://maven.cloudsmith.io/WORKSPACE/REPOSITORY/") }
...
```scala
resolvers += "NAME" at "https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/maven/"
```
...
resolvers += "NAME" at "https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/maven/"
```
```scala HTTP Basic Authentication
resolvers += "NAME" at "https://dl.cloudsmith.io/basic/WORKSPACE/REPOSITIORY/maven/"
```
