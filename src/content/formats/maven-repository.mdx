...
```shell
cloudsmith push maven WORKSPACE/REPOSITORY ARTIFACT_ID-PACKAGE_VERSION.jar --pom-file=ARTIFACT_ID-PACKAGE_VERSION.pom
```
...
<repositories>
  <repository>
    <id>NAME</id>
    <url>https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/maven/</url>
    <releases>
...
<repositories>
  <repository>
    <id>NAME</id>
    <url>https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/maven/</url>
    <releases>
      <enabled>true</enabled>
      <updatePolicy>always</updatePolicy>
    </releases>
...
<repositories>
  <repository>
    <id>NAME</id>
    <url>https://dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/maven/</url>
    <releases>
      <enabled>true</enabled>
      <updatePolicy>always</updatePolicy>
    </releases>
