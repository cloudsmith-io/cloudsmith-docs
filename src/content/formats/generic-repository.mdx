...
| PREFIX        | Optional upstream prefix (e.g., `node_distributions/`) for files cached from upstreams   |
...
```text
https://dl.cloudsmith.io/public/OWNER/REPOSITORY/generic/PREFIX/FILEPATH
```
...
```shell
curl -sLf -O 'https://dl.cloudsmith.io/public/OWNER/REPOSITORY/generic/node_distributions/latest/node-v4.9.1.tar.gz'
```
...
```shell
curl -sLf -O 'https://dl.cloudsmith.io/TOKEN/OWNER/REPOSITORY/generic/PREFIX/FILEPATH'
```
...
```shell
curl -sLf -u "USERNAME:PASSWORD" -O 'https://dl.cloudsmith.io/basic/OWNER/REPOSITORY/generic/PREFIX/FILEPATH'
```
