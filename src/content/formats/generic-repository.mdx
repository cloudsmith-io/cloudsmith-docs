...
```text
https://dl.cloudsmith.io/public/OWNER/REPOSITORY/generic/UPSTREAM_PREFIX/FILEPATH
```
...
```shell
curl -sLf -O 'https://dl.cloudsmith.io/TOKEN/OWNER/REPOSITORY/generic/UPSTREAM_PREFIX/FILEPATH'
```
...
```shell
curl -sLf -u "USERNAME:PASSWORD" -O 'https://dl.cloudsmith.io/basic/OWNER/REPOSITORY/generic/UPSTREAM_PREFIX/FILEPATH'
```
