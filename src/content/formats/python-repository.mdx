...
<Note>📘 The main examples in this docs use `pip` or the Cloudsmith CLI. If you use [UV](https://docs.astral.sh/uv/) and wants to learn how to integrate it with Cloudsmith, jump to the [UV Support section](#uv-support).</Note>
...
```
https://python.cloudsmith.io/WORKSPACE/REPOSITORY/
```
...
index-servers =
  ...
  cloudsmith
[cloudsmith]
  repository: https://python.cloudsmith.io/WORKSPACE/REPOSITORY/
  username: USERNAME
  password: API-KEY
```
...
```shell
cloudsmith push python WORKSPACE/REPOSITORY PACKAGE_NAME-PACKAGE_VERSION.whl
```
...
```shell
pip install PACKAGE_NAME==PACKAGE_VERSION --index-url https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/python/simple/
```
...
```
--index-url https://dl.cloudsmith.io/public/WORKSPACE/REPOSITORY/python/simple/
...
pip install PACKAGE_NAME==PACKAGE_VERSION --index-url https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/python/simple/
```
```shell HTTP Basic Auth (User & Pass)
pip install PACKAGE_NAME==PACKAGE_VERSION --index-url https://USERNAME:PASSWORD@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/python/simple/
```
```shell HTTP Basic Auth (API-Key)
pip install PACKAGE_NAME==PACKAGE_VERSION --index-url https://USERNAME:API-KEY@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/python/simple/
```
```shell HTTP Basic Auth (Token)
pip install PACKAGE_NAME==PACKAGE_VERSION --index-url https://token:TOKEN@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/python/simple/
```
...
--index-url https://dl.cloudsmith.io/TOKEN/WORKSPACE/REPOSITORY/python/simple/
PACKAGE_NAME==PACKAGE_VERSION
```
```text HTTP Basic Auth (User & Pass)
--index-url https://USERNAME:PASSWORD@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/python/simple/
PACKAGE_NAME==PACKAGE_VERSION
```
```text HTTP Basic Auth (API-Key)
--index-url https://USERNAME:API-KEY@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/python/simple/
PACKAGE_NAME==PACKAGE_VERSION
```
```text HTTP Basic Auth (Token)
--index-url https://token:TOKEN@dl.cloudsmith.io/basic/WORKSPACE/REPOSITORY/python/simple/
PACKAGE_NAME==PACKAGE_VERSION
```
...
Let's start defining a new `pyproject.toml` file for your project. Replace `WORKSPACE`, `REPOSITORY` with your own Cloudsmith Workspace and Repository names:
