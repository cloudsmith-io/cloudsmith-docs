...
You can create Standard Entitlement Tokens via the [Website UI](/software-distribution/entitlement-tokens-via-the-website-ui),  via the [Cloudsmith CLI](/software-distribution/entitlement-tokens-via-the-cloudsmith-cli) or via the [Cloudsmith API](/software-distribution/entitlement-tokens-via-the-cloudsmith-api) 
