...
An API Key provides Read and Write access. If you want Read-only access, please use an [Entitlement Token](/distributing-your-software/entitlement-tokens). API Keys and Entitlement Tokens should be treated as secrets to prevent unwarranted access.
