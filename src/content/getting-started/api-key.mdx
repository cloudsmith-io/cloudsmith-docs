...
An API Key provides Read and Write access. If you want Read-only access, please use an [Entitlement Token](doc:entitlements). API Keys and Entitlement Tokens should be treated as secrets to prevent unwarranted access.
