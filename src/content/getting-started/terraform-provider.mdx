...
{/* <script src="https://fast.wistia.com/player.js" async></script><script src="https://fast.wistia.com/embed/obeiaz0ti0.js" async type="module"></script><style>wistia-player[media-id='obeiaz0ti0']:not(:defined) { background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/obeiaz0ti0/swatch'); display: block; filter: blur(5px); padding-top:56.25%; }</style> <wistia-player media-id="obeiaz0ti0" aspect="1.7777777777777777"></wistia-player> */}
...
Please see the [Entitlements](doc:entitlements) documentation for more details on managing entitlement tokens and restrictions. 
