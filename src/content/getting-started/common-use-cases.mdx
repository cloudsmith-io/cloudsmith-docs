...
<Flex gap="s" align="stretch">
  <Card
    ...
    href="/getting-started/common-use-cases#artifact-management-for-the-software-development-lifecycle-sdlc"
  ...
  <Card
    ...
    href="/getting-started/common-use-cases#software-distribution"
    icon="homepage/api"
    type="simple"
    width="full"
  ...
  <Card
    ...
    href="/getting-started/common-use-cases#software-supply-chain-security"
    icon="homepage/api"
    type="simple"
    width="full"
  ...
  <Card
    ...
    href="/getting-started/common-use-cases#software-supply-chain-observability"
    icon="homepage/api"
    type="simple"
    width="full"
    linkText=""
