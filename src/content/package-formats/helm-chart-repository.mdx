...
With public repositores you don't need any sort of authentication and you can jump straight to [Installing a Chart](/package-formats/helm-chart-repository#installing-a-chart/) 
