...
If using Gradle - please see our [Gradle documentation](/package-formats/gradle-repository)  
If using sbt - please see our [sbt documentation](/package-formats/sbt-repository)
