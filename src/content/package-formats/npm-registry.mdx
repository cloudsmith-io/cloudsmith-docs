...
<Note variant="note" headline="Note">
To use `npm audit`, you must authenticate using a Cloudsmith [API-Key](/getting-started/cli#getting-your-api-key), not an [Entitlement Token](https://help.cloudsmith.io/docs/entitlements).
</Note>
