...
Copy this link and add it to your Cloudsmith organization [SAML settings](/access-control/single-sign-on#enable-saml).

## All wrapped up!

Your application should now appear on the OneLogin portal.

You can then enable SAML authentication in your Cloudsmith [SAML settings](/access-control/single-sign-on#enable-saml) and you can use OneLogin to begin logging in straight away.
