...
- See [Setup GitHub Actions to authenticate to Cloudsmith using OIDC](/access-control/setup-cloudsmith-to-authenticate-with-oidc-in-github-actions) for a step-by-step guide.
...
For further details on configuring Github Actions for OIDC see the guide [here](/access-control/setup-cloudsmith-to-authenticate-with-oidc-in-github-actions).
