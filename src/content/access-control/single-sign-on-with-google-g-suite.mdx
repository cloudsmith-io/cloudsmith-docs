...
Once configured as above, you'll need to add the IdP Metadata XML to the [SAML Settings](/access-control/single-sign-on#enable-saml) for your Cloudsmith organization. 
