...
Take this file and add the XML contents to your [SAML settings](/access-control/single-sign-on#enable-saml) in your Cloudsmith organization.
...
You can then enable SAML in your Cloudsmith [SAML settings](/access-control/single-sign-on#enable-saml). 
