...
To resync a package using the Cloudsmith CLI, you first need to identify the package. See [Package Identification](/artifact-management/identifying-a-package) for instructions to do this. 
...
```shell
cloudsmith resync WORKSPACE/REPO/UNIQUE_ID
```
...
## Resync via Cloudsmith web app

You can resync a package via the Cloudsmith web app:
