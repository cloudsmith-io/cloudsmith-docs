...
|----------|----------|----------|
| Enabled?  | `retention_enabled`     | If checked, the retention rules will be activated for the repository. Any packages that don't match will be deleted automatically, and the rest are retained.      |      
