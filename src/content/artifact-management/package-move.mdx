...
To move a package using the Cloudsmith CLI, you first need to identify the package you wish to move.  See [Package Identification](/artifact-management/identifying-a-package) for full instructions on identifying packages. 
...
```shell
cloudsmith move WORKSPACE/SOURCE_REPO/UNIQUE_ID  DESTINATION_REPO
```
