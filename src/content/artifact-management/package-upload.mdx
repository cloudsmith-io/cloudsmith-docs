...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/20dc72a883f23158ebf13e385388ed19c35c6199a3e27aa1ff6c4c666f5e9964-app.cloudsmith.com_demo_logsiPad_Pro_5.png",
        "upload-package-ui.png",
        1309
      ],
      "align": "center",
      "border": true,
      "caption": "Native CLI / API / Tools tab"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ef68d0959c514998f85af03d168b1ccce7021f38b42ea9e1c537215371afe88-app.cloudsmith.com_demo_logsiPad_Pro_7.png",
        "",
        "Select your desired package format"
      ],
      "align": "center",
      "border": true,
      "caption": "Select your desired package format"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c62146aa1eef8a71d61018ac8c799c1ce07466e2a1fe7142899685071bf0a964-app.cloudsmith.com_demo_logsiPad_Pro_6.png",
        "",
        "Native instructions for your package format"
      ],
      "align": "center",
      "border": true,
      "caption": "Native instructions for your package format"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3798e22-Screenshot_2020-01-02_at_14.25.25.png",
        "Screenshot 2020-01-02 at 14.25.25.png",
        1119
      ],
      "align": "center",
      "sizing": "smart",
      "caption": "cloudsmith push CLI example"
    }
  ]
}
[/block] */}
...
Please see [Package Tags](doc:package-tags) for more information on package tagging
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2728021-Screenshot_2022-03-28_at_18.05.32.png",
        "Screenshot 2022-03-28 at 18.05.32.png",
        1555
      ],
      "align": "center",
      "caption": "Send PUT req to Cloudsmith using Postman (step 1 of 2 to upload a package)"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fc5e591-Screenshot_2022-03-28_at_18.07.04.png",
        "Screenshot 2022-03-28 at 18.07.04.png",
        1531
      ],
      "align": "center",
      "caption": "Send POST req to Cloudsmith using Postman (step 2 of 2 to upload a package )"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cb7081e9eb3d7e1c3712da98163cd36e00165970ee71ee170a05962dca9a74ea-app.cloudsmith.com_demo_logsiPad_Pro_5.png",
        "upload-package-dropdown.png",
        1301
      ],
      "align": "center",
      "border": true,
      "caption": "Push/Pull Packages"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5eef910122a211c00271a4edaf8e195ea1bc6217487219667964b37365f906e7-app.cloudsmith.com_demo_logsiPad_Pro_7.png",
        "",
        "Package format selection in the Push/Pull Packages menu"
      ],
      "align": "center",
      "border": true,
      "caption": "Package format selection in the Push/Pull Packages menu"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b060eb5a2fde76bc75fefcfac7242484e80d6c91e88170e8a115a4c9b27f6ecd-app.cloudsmith.com_demo_logsiPad_Pro_8.png",
        "upload-package-form.png",
        593
      ],
      "align": "center",
      "border": true,
      "caption": "Package upload form"
    }
  ]
}
[/block] */}
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f16205121dfdbde1528fa0f65b13740aa435ca30df7a59532f0be42e7d0f8af1-app.cloudsmith.com_demo_logsiPad_Pro_9.png",
        "republish-package-setting.png",
        1315
      ],
      "align": "center",
      "border": true,
      "caption": "Package Republish Setting"
    }
  ]
}
[/block] */}
