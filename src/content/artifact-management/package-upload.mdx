...
```
https://upload.cloudsmith.io/WORKSPACE/REPOSITORY/PACKAGE_NAME
```
...
```
https://api.cloudsmith.io/packages/WORKSPACE/REPOSITORY/upload/FORMAT/
```
...
```
https://api.cloudsmith.io/packages/WORKSPACE/REPOSITORY/upload/raw/
```
...
Tags are created by us automatically, and they wouldn't influence how a tool like `pip` can retrieve packages. So the way to go here would be to encode the information as Metadata into the version.
