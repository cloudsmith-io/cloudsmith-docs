...
To copy a package using the Cloudsmith CLI, you first need to identify the package.  See [Package Identification](doc:identifying-a-package) for full instructions on identifying packages. 
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/73d2343-copy-pkg-cli.png",
        "copy-pkg-cli.png",
        878
      ],
      "align": "center",
      "sizing": "smart",
      "caption": "cloudsmith copy CLI example"
    }
  ]
}
[/block] */}
...
for the `-q` query you can use any terms that you would use when searching for a package (see [Search / Filter Packages](doc:search-filter-packages) for full details). For example: 
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c0fe9e7f6a94d3e67481271bf3b87c87854bc8dcd530bd9257af9084eb249fe5-pckgcopy.png",
        "",
        ""
      ],
      "align": "center"
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ae80b5ebfb4cc08804fde42b194168add7dcc0af33192fd6d772aef4e1624867-pckgcopy2.png",
        "",
        ""
      ],
      "align": "center"
...
{/* [block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5c4d3d82e60dfc5aab3d4866add99550c5b4ecb7e8d387fb0bd29ac927e3b697-Screenshot_2024-11-12_at_2.11.39_PM.png",
        "",
        ""
      ],
      "align": "center"
