...
for the `-q` query you can use any terms that you would use when searching for a package (see [Search / Filter Packages](/artifact-management/search-packages) for full details). For example: 
