...
In order to use the Cloudsmith CLI with Google CloudBuild, we recommend you to create a **Cloudsmith [service account](/accounts-and-teams/service-account)** and use its API key instead of a personal API key. This is more secure, easier to audit, and better suited for CI/CD environments like Google CloudBuild.
