...
1. **Create a [Service Account](doc:service-accounts)** in Cloudsmith (required for OIDC to work with Cloudsmith).
2. **Configure [OpenID Connect](doc:openid-connect) in Cloudsmith**:
...
For more details, refer to the [Cloudsmith OIDC documentation](doc:openid-connect) and [Codefresh OIDC documentation](https://codefresh.io/docs/docs/integrations/oidc-pipelines/). 
...
For more information consult the [Docker Registry](doc:docker-registry) or [Codefresh documentation](https://codefresh.io/docs/docs/integrations/docker-registries/other-registries/).
...
- Add Existing Helm Repository:
  ...
  - Repository URL:  https://dl.cloudsmith.io/basic/OWNER/REPOSITORY/helm/charts/
...
- [Helm Chart Repository](/supported-formats/helm-chart-repository)
- [Docker Registry](/supported-formats/docker-registry)
