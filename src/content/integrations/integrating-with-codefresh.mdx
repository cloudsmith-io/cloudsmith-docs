...
- **Uploading Packages:**
  - Use the Cloudsmith [Command-Line Interface](/getting-started/cli).
...
1. **Create a [Service Account](/teams-and-accounts/service-accounts)** in Cloudsmith (required for OIDC to work with Cloudsmith).
2. **Configure [OpenID Connect](/access-control/openid-connect) in Cloudsmith**:
...
For more details, refer to the [Cloudsmith OIDC documentation](/access-control/openid-connect) and [Codefresh OIDC documentation](https://codefresh.io/docs/docs/integrations/oidc-pipelines/). 
...
- Add Existing Helm Repository:
  ...
  - Repository URL:  
    ...
    - Replace [OWNER] and [REPOSITORY] with your Cloudsmith organization and repository.
  - HELMREPO_PASSWORD
...
- [OpenID Connect](/access-control/openid-connect)
- [ArgoCD](/integrations/argocd)
- [Octopus Deploy](/integrations/integrating-octopus-deploy)
