...
For more information consult the [Docker Registry](/supported-formats/docker-registry) or [Codefresh documentation](https://codefresh.io/docs/docs/integrations/docker-registries/other-registries/).
