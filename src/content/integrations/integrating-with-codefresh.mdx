...
For more information consult the [Docker Registry](/package-formats/docker-registry) or [Codefresh documentation](https://codefresh.io/docs/docs/integrations/docker-registries/other-registries/).
...
- [Helm Chart Repository](/package-formats/helm-chart-repository)
- [Docker Registry](/package-formats/docker-registry)
