...
5. Select 'Package Synchronized' from the row of events 
6. Add your handlebars code; the template below produced the message shown above
7. Under 'Webhook Event Subscriptions' select  'Send Specific Events (choose)' then check 'Package Synchronized'
8. 'Create Webhook'
...
For more information about the events triggered by the package synchronization process please see [here](/developer-tools/webhooks#webhook-event-types)
</Note>
