...
For more information about the events triggered by the package synchronization process please see [here](/logs-and-observability/webhooks#webhook-event-types)
</Note>
