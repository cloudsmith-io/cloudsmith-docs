...
import addApiKeyParameter from './images/teamcity/addApiKeyParameter.png';
import enabledVersionedSettings from './images/teamcity/enabledVersionedSettings.png';
...
<BlockImage src={addApiKeyParameter} alt=""></BlockImage>
...
<BlockImage src={enabledVersionedSettings} alt=""></BlockImage>
