import { Video, CodeBlock, Tabs, TabsContent, TabsList, TabsTrigger } from '@/components';
...
<Tabs defaultValue="auth1">
  <TabsList>
    <TabsTrigger value="auth1">Entitlement Token Auth</TabsTrigger>
    <TabsTrigger value="auth2">HTTP Basic Auth (User & Pass)</TabsTrigger>
    <TabsTrigger value="auth3">HTTP Basic Auth (API-Key)</TabsTrigger>
    <TabsTrigger value="auth4">HTTP Basic Auth (Token)</TabsTrigger>
  </TabsList>
