...
1. A PUT req against the upload URL: https://upload.cloudsmith.io/WORKSPACE/REPOSITORY/PACKAGE_NAME.  
...
1. Populate the request with the POST url: https://api.cloudsmith.io/packages/CLOUDSMITH_ORG/CLOUDSMITH_REPO/upload/raw/
