...
import dependabotSecretsImage from './images/dependabot/dependabot-secrets.png';
import enableDependabotImage from './images/dependabot/enable-dependabot.png';
import veryfiyConnectionImage from './images/dependabot/verify-connection.png';
...
1. Copy your API key from Cloudsmith using the instructions [here](/getting-started/api-key).
...
<BlockImage src={dependabotSecretsImage} alt=""></BlockImage>
...
<BlockImage src={enableDependabotImage} alt=""></BlockImage>
...
<BlockImage src={veryfiyConnectionImage} alt=""></BlockImage>
