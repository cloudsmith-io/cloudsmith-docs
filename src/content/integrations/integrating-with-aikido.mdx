...
<Note>📘 Ensure you use API keys or Entitlement token with appropriate permissions for accessing and scanning container images.</Note>
...
If you experience any issues, consult the [Aikido Help Documentation ](https://help.aikido.dev/container-image-scanning/standalone-registries/cloudsmith-container-registry)or contact Aikido support.
