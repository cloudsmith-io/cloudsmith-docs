...
<a target="_blank" href="https://youtu.be/yOaDVQy7RpA"><img src="https://files.readme.io/338652e-cloudsmith-youtube-play-buildkite-small.png"/></a>
...
Please see the [Cloudsmith CLI](/getting-started/cli) documentation for more details of the syntax of the `cloudsmith push` command and the [Supported Formats](/supported-formats) page for examples of the `cloudsmith push` command for each supported format. 
