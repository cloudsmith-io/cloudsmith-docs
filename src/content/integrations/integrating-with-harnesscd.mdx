...
|Docker Image Name|The name of the Docker image. In the format WORKSPACE/REPOSITORY/IMAGE-NAME, where WORKSPACE is your Cloudsmith Organization / Account name, REPOSITORY is your Cloudsmith Repository identifier, and IMAGE-NAME your the Docker image name in the repository.|