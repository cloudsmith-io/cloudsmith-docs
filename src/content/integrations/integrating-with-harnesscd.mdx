...
You can obtain your [Cloudsmith API Key](/accounts-and-teams/api-key) from using the Cloudsmith CLI or via the [API Settings](https://app.cloudsmith.com/settings/api-keys) page when logged in to the Cloudsmith Website.
