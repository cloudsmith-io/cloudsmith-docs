...
For CI/CD, we would usually recommend that you create a Service Account in your organization. See [Service Accounts](/teams-and-accounts/service-accounts) for more details.
</Note>
