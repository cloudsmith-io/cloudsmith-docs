...
For more information about the events triggered by the package synchronization process please see [our Webhook documentation.](/logs-and-observability/webhooks#webhook-event-types)
</Note>