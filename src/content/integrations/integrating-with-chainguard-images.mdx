...
How to integrate with Chainguard Images using Cloudsmith

<Video wistiaId="reqdqpkks0"></Video>

[Chainguard](https://www.chainguard.dev), a Docker Verified Publisher, offers Chainguard Images which are a collection of minimal, hardened Docker container images featuring:
...
1. **Configure Upstream Proxying**  
   ...
   - For Chainguard's public images: `https://cgr.dev/chainguard`
