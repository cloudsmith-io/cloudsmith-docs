...
The API Key Policy is available with our Enterprise plans.
...
To regain access, the user should update their [API Key](/accounts-and-teams/api-key) by clicking "Refresh" within the API settings page. 
