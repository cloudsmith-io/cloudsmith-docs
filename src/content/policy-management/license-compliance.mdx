...
import licence_compliance from './images/license-compliance/license_compliance.png'
import img26d0615_licence_details from './images/license-compliance/26d0615-licence-details.png'

# License Compliance

License Compliance provides you with an overall view of license policy violations for your Workspace or Repository as a whole.

<BlockImage src={licence_compliance} alt="License Compliance Overview"></BlockImage>

If you're interested in restricting the use of packages with certain licenses, please review our [License Policy documentation](/policy-management/license-policy) to learn how to use policies to automatically quarantine packages and ensure organizational compliance.
...
<Note variant="note" headline="Dependencies">
  Cloudsmith provides License data for the packages it knows about or has access to. A package might have a dependency on another package with a different license which is unknown and therefore not reported.
</Note>
