...
import ix from './images/vulnerability-policy/2fe13f1-cross_red.png'
...
<Note> A cooldown policy is always set to **Terminal**, which prevents the evaluation of any further policies if this policy matches. 
