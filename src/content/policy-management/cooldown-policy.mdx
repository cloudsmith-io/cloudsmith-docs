...
<Note> When created from a template, your cooldown policy is disabled by default. 
</Note>
...
<Note> After a cooldown policy is created, it may take several minutes for the non-compliant packages in your Cloudsmith workspace to appear as **HIDDEN**.
</Note>
