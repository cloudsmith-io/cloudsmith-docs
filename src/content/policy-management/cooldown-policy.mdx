...
<Note>A cooldown policy is always set to **Terminal**, which prevents the evaluation of any further policies if this policy matches. This setting cannot be edited. 
</Note>
...
<Note> Only one cooldown policy can be created per workspace. 
</Note>
