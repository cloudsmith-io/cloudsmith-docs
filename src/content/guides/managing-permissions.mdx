...
If you are using [Single Sign On (SSO)](/authentication/single-sign-on), it is also possible to automate team membership based on groups from your Identity Provider using SAML Group Sync.
...
With this guide, you are equipped to harness Cloudsmith's capabilities and ensure that your software supply chain is secure, scalable, and streamlined.
