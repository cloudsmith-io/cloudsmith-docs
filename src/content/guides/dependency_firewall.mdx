...
<Note>📘 Cloudsmith provides full controls to define who can view or make changes to your repos. Learn more about permissions and entitlements [here](/repositories/access-controls).</Note>
