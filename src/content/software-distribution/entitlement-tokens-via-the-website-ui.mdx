...
<Note variant="note">
  Please see [Sharing a Private Package](/artifact-management/sharing-a-private-package) for an example of configuring an Entitlement Token using the Website UI.
</Note>
