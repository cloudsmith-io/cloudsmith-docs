...
1. **Generate a Temporary Token:** Use the [broadcast-token endpoint](https://help.cloudsmith.io/reference/) to generate a temporary access token. The API requires the secret key from an existing entitlement token as input.
