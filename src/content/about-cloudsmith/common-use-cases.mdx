...
<Flex gap="s" align="stretch">
  ...
  <Card
    ...
    description="A platform to securely and reliably distribute software to customers at scale."
...
<Flex gap="s" align="stretch">
 ...
 <Card
    ...
    description="The Datadog Cloudsmith Integration is a simple and effective visualization tool for your workspace."
    href="/integrations/integrating-with-datadog"
    icon="utility/api"
    type="simple"
    width="full"
    linkText="Integrate with Datadog"
  />
  <Card
