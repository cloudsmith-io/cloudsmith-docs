...
11. If viable and fixed, we will publicly thank you on our [Hall of Fame](/resources/exploits-hall-of-fame).
...
- Any "third-party" website that we use to host a service but do not control uses _their_ bug bounty program, e.g.:
  - [Status Website (https://status.cloudsmith.com)](https://status.cloudsmith.com) - this is hosted by [Incident.io](https://incident.io).
  - [Support Website (https://support.cloudsmith.com)](https://support.cloudsmith.com) - this is hosted by [Zendesk](https://www.zendesk.com).
...
- Any third-party widgets, such as:
  ...
  - Status widget (powered by [Incident.io](https://incident.io)).
