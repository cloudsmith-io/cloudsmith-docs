...
Fill out the service form, and give your service a name. Optionally, add a description and select any teams in your organization to associate with the service. 
