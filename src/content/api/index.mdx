...
- [v1](https://api.cloudsmith.io/)
- [v2](https://api.cloudsmith.io/v2)
...
You can [find your API Key](/about-cloudsmith/api-key) within your User Settings or you can request (or reset) it via the Users Token API Endpoint.
