...
<Note>
Audit logs are available to customers on Pro, Ultra, and Enterprise plans.
</Note>
...
Cloudsmith retains audit logs for up to 1 year, depending on your plan level.

| **Plan**                          | **Audit log retention period**            |
| --------------------------------- | ----------------------------------------- |
| Pro                               | 30 days                                   |
| Ultra                             | 60 days                                   |
| Enterprise                        | Custom                                    |

<Note variant="note" headline="Enterprise plans">
The default audit log retention period for Enterprise plans is 1 year. To update your retention period, please reach out to your customer success manager.
</Note>