...
<Note>
📘 Due to the addition of new features, some of the legacy graphs displayed in this section will be deprecated:
- Package delivery
- Packages
- Container images
...
This will increase with time as more artifacts are stored within your Workspace. [Retention Rules](/artifact-management/retention-lifecycle) can help to automate storage management.
