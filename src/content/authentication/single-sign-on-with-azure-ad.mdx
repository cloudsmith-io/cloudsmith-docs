...
This guide provides step-by-step instructions on setting up [Azure AD](https://azure.microsoft.com/en-gb/services/active-directory/) as a SAML IdP for your Cloudsmith Organization.
...
Go back to Azure AD and set the Tenant URL to: `https://app.cloudsmith.com/scim/v2` and the "Secret token" to the copied token from Cloudsmith, click "Save" and "Test connection"
