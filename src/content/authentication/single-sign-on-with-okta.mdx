...
Copy this metadata and add it to your Cloudsmith organization [SAML settings](/authentication/saml) as Inline XML.
...
You can also optionally set up [SAML Group Sync mappings](/authentication/saml) to automatically map OKTA groups to teams in your Cloudsmith organization, and SCIM to provision, deprovision and update user profile information.
