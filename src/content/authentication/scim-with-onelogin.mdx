...
After enabling SCIM, proceed to OneLogin's Getting Started Guide to complete the setup process. Follow the detailed instructions in their SCIM documentation:  
