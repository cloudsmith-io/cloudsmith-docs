...
[Jenkins Documentation](https://plugins.jenkins.io/oic-auth/)

- See [Setup Jenkins to authenticate to Cloudsmith using OIDC](/authentication/setup-jenkins-to-authenticate-to-cloudsmith-using-oidc) for a step-by-step guide.
...
Additionally, as of version `2.0.0` of the Cloudsmith orb, you can use the `authenticate-with-oidc` command to perform this step automatically.
