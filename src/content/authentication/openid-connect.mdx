...
- See [Setup Jenkins to authenticate to Cloudsmith using OIDC](authentication/setup-jenkins-to-authenticate-to-cloudsmith-using-oidc.mdx) for a step-by-step guide.
