...
To determine your **Identifier** and **Reply URL** (we use the same value for both) we use the following format: "https://app.cloudsmith.com/WORKSPACE/authentication/saml/acs/", where "WORKSPACE" is replaced with your workspace's slug.
