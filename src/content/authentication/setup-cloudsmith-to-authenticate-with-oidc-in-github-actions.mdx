...
1. Create a Service Account in Cloudsmith:
   1. [Service accounts ](docs:service-accounts)are a specific type of account that allows you to create a Cloudsmith API Key not tied to a specific user.
...
2. Set Access Controls
   1. Configure the repository access controls to allow the [Service Account ](docs:access-controls)to push packages to Cloudsmith.
