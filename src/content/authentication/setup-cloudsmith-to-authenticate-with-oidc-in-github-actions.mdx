...
1. Create a Service Account in Cloudsmith:
   1. [Service accounts ](/teams-and-accounts/service-accounts)are a specific type of account that allows you to create a Cloudsmith API Key not tied to a specific user.
