...
Once configured, you'll be able to access the SAML login page of your organization at the following URL:  https://app.cloudsmith.com/WORKSPACE/saml/login/

Where _WORKSPACE_ is your organization's slug/identifier (what you would normally see in the URL when accessing your organization within Cloudsmith). If you're not sure what this is, just ask us.
