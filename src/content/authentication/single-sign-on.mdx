...
Where _WORKSPACE_ is your workspace's slug/identifier (what you would normally see in the URL when accessing your workspace within Cloudsmith). If you're not sure what this is, just ask us.

## Enable SAML

<Note>📘 To enable SAML, contact [Cloudsmith Support](https://cloudsmith.com/company/contact-us)</Note>
