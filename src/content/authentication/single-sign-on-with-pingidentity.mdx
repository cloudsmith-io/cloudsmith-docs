...
- `ACS URLS`: `https://app.cloudsmith.com/WORKSPACE/saml/acs/`
- `ENTITY ID`: `https://app.cloudsmith.com/WORKSPACE/saml/acs/`

Replace the values with your `WORKSPACE` name, then click **Save**. Click on the new application and select the "Configuration" tab. Use the following details to complete configuration.
