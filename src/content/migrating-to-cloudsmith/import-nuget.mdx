...
Once you have exported all your NuGet packages (.nupkg files) you can upload them to Cloudsmith. 

First make sure you [install the Cloudsmith CLI ](/developer-tools/cli#installation).
...
$SourceFolder = '/your/full/path/to/folder/containing/nupkgs/here'
...
# this script takes in 3 parameters from the command line:
