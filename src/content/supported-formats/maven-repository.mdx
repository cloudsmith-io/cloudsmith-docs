...
If using Gradle - please see our [Gradle documentation](doc:gradle-repository)  
If using sbt - please see our [sbt documentation](doc:sbt-repository)
...
Please see the [Troubleshooting Maven](doc:troubleshooting-maven) page for further help and information.
