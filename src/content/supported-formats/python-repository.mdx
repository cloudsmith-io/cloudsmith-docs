import { BlockImage, Card, Flex } from '@/components';
import pythonVideoImage from './images/b6d41b3-cloudsmith-youtube-play-python-small.png';
...
| TOKEN           | Your Cloudsmith Entitlement Token (see [Entitlements](/entitlements) for more details) |
...
<span className="cs-tag cs-tag-dark-green">Supported</span>
Please see our [Security Scanning](doc:security-scanning) documentation for further information.{' '}

## Upstream Proxying / Caching

<span className="cs-tag cs-tag-dark-green">Configurable Proxying</span>
<span className="cs-tag cs-tag-orange">Caching</span>.

Please see [Upstream Proxying](doc:upstream-proxying-caching) for more details.
...
<span className="cs-tag cs-tag-blue">GPG</span>
