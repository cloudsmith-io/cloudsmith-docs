...
excerpt: "Cloudsmith provides public & private repositories for Dart packages"
---
...
<a href="https://youtu.be/cpW4fK_y4zU" target="_blank"><img src="https://files.readme.io/2c343eb-cloudsmith-youtube-play-dart-small.png" /></a>
...
No further setup is required when using Dart SDK >= 2.15 with public repositories, you can add a dependency from this repository to your package `pubspec.yaml` automatically with `dart pub`. See [Installing a Package](https://help.cloudsmith.io/docs/dart-repository#sdk-version--215)
