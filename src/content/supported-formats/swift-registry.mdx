...
Follow the steps in [Configure Cloudsmith as your Swift Registry](https://help.cloudsmith.io/docs/swift-registry#configure-cloudsmith-as-your-swift-registry) to configure Cloudsmith as your Swift registry.
