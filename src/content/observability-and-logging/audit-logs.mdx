...
Audit Logs provide a log of events across your organization, such as [creating](doc:create-a-repository)/[deleting](ref:repos_delete) a repository or modifications to repository settings/configuration. 
