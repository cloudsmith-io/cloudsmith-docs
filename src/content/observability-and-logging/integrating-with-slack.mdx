...
For more information about the events triggered by the package synchronization process please see [here](/observability-and-logging/webhooks#webhook-event-types)
</Note>
