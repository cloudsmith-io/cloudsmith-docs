import { BlockImage, Button, Card, Flex, Navbar, Note, Video, CodeBlock } from '@/components';
...
<CodeBlock
  lang="yaml"
  header={false}
  code="cliVersion: '1.3.1' # Example CLI version authMethod: 'apiKey' apiKey: '$(CLOUDSMITH_API_KEY)'"
/>
