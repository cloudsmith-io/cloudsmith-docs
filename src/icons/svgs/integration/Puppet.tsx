...
export const IntegrationPuppetIcon = createIcon<SpecificIconProps>(
  'integration/puppet',
  ({ width = 395, height = 395, ...props }) => ({
    ...props,
    width,
    height,
    viewBox: '0 0 395 395',
