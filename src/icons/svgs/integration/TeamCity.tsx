...
export const IntegrationTeamCityIcon = createIcon<SpecificIconProps>(
  ...
  ({ width = 128, height = 128, ...props }) => ({
    ...
    children: (
      <>
        ...
        <linearGradient id="b" x1="66.73" y1="-662.84" x2="26.4" y2="-613.01" gradientTransform="matrix(1 0 0 -1 0 -585.01)" gradientUnits="userSpaceOnUse">
            ...
            <stop offset=".21" stop-color="#868686"/>
            <stop offset=".37" stop-color="#858585"/>
            <stop offset=".54" stop-color="#848484"/>
            <stop offset=".71" stop-color="#828282"/>
            <stop offset=".88" stop-color="#7F7F7F"/>
            <stop offset=".97" stop-color="#7E7E7E"/>
        </linearGradient>
    ...
    <path d="M45.92 2.92a25 25 0 0 0-5.53-2c-25.7-6.1-44.8 19.1-34.3 42 .1.1 18.7 40.9 21.7 47.4 0 0 34.2-15.7 41.2-31.8 6.48-15-4.45-42.38-6.45-46.49z" fill="url(#b)"/>
    <path d="M123.19 48.43a24.36 24.36 0 0 0-8.6-8c-.1 0-24.1-13.2-24.1-13.2S8.09 75 8 75.13c-9.3 10.6-11.4 27.4-.7 42a25.22 25.22 0 0 0 13 9.2c9.7 3 18.3 1.8 25.5-2 .2-.1 67.7-35.9 67.9-36.1 13.19-6.9 19.3-24.5 9.49-39.8z" fill="#868686"/>
    <path d="M38.42 37.94l-22 27-8.53 10.19c-9.3 10.6-11.4 27.4-.7 42a25.22 25.22 0 0 0 13 9.2c9.7 3 18.4 1.8 25.6-2 0 0 1.7-.9 4.6-2.5 9.14-4.94 21.75-38.15 30.35-63.83z" fill="url(#a)"/>
    <path d="M73 63.93L90.49 27a.1.1 0 0 1 .1-.1c.1-.3 1.5-3.9 1.6-4.1a17 17 0 0 0-1.8-15.9 14.29 14.29 0 0 0-8.9-6.3 16.4 16.4 0 0 0-17.1 5.7c-.1.1-3.9 4.5-3.9 4.5l-28 34.5z" fill="url(#c)"/>
    <g>
