...
export const FormatSbtIcon = createIcon<SpecificIconProps>(
  'format/sbt',
  ({ width = 257, height = 148, ...props }) => ({
    ...props,
    width,
    height,
    viewBox: '0 0 257 148',
    ...
    children: (
      <>
        ...
        <g id="Layer_3">
          <path
            fill="currentColor"
            d="M17.417,106.458l-13.25,12c0,0,6.5,8.125,15.125,13s13.381,4.508,23.065,4.379
		...
		s25.123,6.469,25.123,14.286s-6.101,10.692-15.851,10.817S17.417,106.458,17.417,106.458z"
          ...
          <path
            fill="currentColor"
            d="M198.508,45.484l0.2,18.199h10.4l0.1,53.9c0,0,1.801,6.2,6.5,10.8c6.065,5.937,12.4,7.454,12.4,7.454
		...
		l0.2,35.4H198.508z"
          ...
          <path
            fill="currentColor"
            d="M156.667,49.833c-12.529-2.767-25.25-1.375-33.375,3.375l10.625-43.125l-21.188-5.188L82.604,126.333
