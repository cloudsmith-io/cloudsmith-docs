...
export const UtilityGuideIcon = createIcon('utility/guide', () => ({
  fill: 'none',
  children: (
    <>
      <path
      ...
      <path
        ...
        strokeWidth="1.86255"
      />
      <path d="M17.0908 37V26.7896M17.0908 15.7686V12.019" stroke="var(--base-color-blue-500)" strokeWidth="1.86255" />
    </>
  ),
}));
